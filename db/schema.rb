...
ActiveRecord::Schema.define(version: 20171102173611) do
  ...
  create_table "definition_attributes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["definition_model_id"], name: "index_definition_attributes_on_definition_model_id"
    t.index ["name"], name: "index_definition_attributes_on_name"
  end

  create_table "definition_models", force: :cascade do |t|
    t.string "name", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
